...
namespace OtpAuthServices.Controllers
{
    ...
    public class AuthController : ControllerBase
    {
        ...
        public AuthController(IMemoryCache cache,IConfiguration configuration, IOptions<TwilioSettings> twilioSettings,IOptions<bhashsms> bhashsms, ICosmosDbService<UserOnBoarding> cosmosDbService)
        {
            _memoryCache = cache;
       ...
       [EnableRateLimiting("ratepolicy")]
        ...
        //    string mobile = lmart.mobilenumb?.Trim();
        //    if (string.IsNullOrWhiteSpace(mobile))
        //        return BadRequest("Mobile number is required.");
        ...
        //    // ✅ Hardcoded mobile number and OTP
        //    string staticMobile = "9988006789";
        //    string staticOtp = "368958";

        //    // First check against hardcoded values
        //    if (request.SenderValue == staticMobile && request.Otp == staticOtp)
        //    {
        //        return Ok(new { Message = "OTP validated successfully (static check)." });
        //    }
